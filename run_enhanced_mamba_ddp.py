...
def setup_environment(num_gpus):
    """设置训练环境"""
    # 设置环境变量
    env_vars = {
...
def show_batch_size_info():
    ...
    print("\n示例命令:")
    print("  python /media/zdp1/Datas1/cly/U-Mamba/run_enhanced_mamba_ddp.py 4 0.5")

def main():
    print("改进版Enhanced Mamba 3D UNet DDP训练")
    print("=" * 50)
    ...
    if success:
        ...
        print("\n训练失败，请检查错误信息!")
        print("\n调试建议:")
        print("1. 运行调试脚本检查DDP环境:")
        print("   python /media/zdp1/Datas1/cly/U-Mamba/test_ddp_fix.py")
        print("2. 检查是否有其他进程占用了GPU资源:")
        print("   nvidia-smi")
        print("3. 尝试进一步降低batch size因子")
