...
nnUNet_raw = join('/home/zdp1/U-Mamba/data/nnUNet_raw', 'nnUNet_raw') # os.environ.get('nnUNet_raw')
nnUNet_preprocessed = join('/home/zdp1/U-Mamba/data/nnUNet_preprocessed', 'nnUNet_preprocessed') # os.environ.get('nnUNet_preprocessed')
nnUNet_results = join('/home/zdp1/U-Mamba/data/nnUNet_trained_models', 'nnUNet_results') # os.environ.get('nnUNet_results')
